...
const MidSection = () => {
    return (
        <div className="px-[60px] lg:px-[90px] flex flex-col items-center pt-4">
            <CurlyArrow/>

            <section className="flex flex-col md:flex-row md:justify-between justify-center items-center rounded-[12px] w-full md:pr-[66px] py-8 -mt-16 bg-gradient-to-r from-[#f8f8ff] to-[#fdf4fe]">
                <span className="">
                    <TextBlob/>
                </span>

                <div className="lg:w-[570px] w-[80%] text-center md:text-left">
