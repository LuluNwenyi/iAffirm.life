...
const Header = () => {
  ...
  {/* mobile navigation */}
      <div className={`px-[32px] block md:hidden border-t-[2px] border-page-blue shadow-md w-[80%] absolute bg-white z-[20] left-[10vw] transition-[top] duration-500 text-[14px] sm:text-[15px] pt-4 ease-in ${!showMenu ? "-top-72" : "top-[60px]"}`}>
